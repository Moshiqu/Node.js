...
type UserInfo = { username: string, password: string, captcha: string };
...
const View: React.FC = () => {
    ...
    const [loginInfo, setLoginInfo] = useState<UserInfo>({ username: "", password: "", captcha: "" })
            ...
            <div className={style.loginBox + " loginbox"}>
                ...
                <div className="form">
                    <Space direction="vertical" size="large" style={{ display: 'flex' }}>
                        <Input placeholder='用户名' onChange={e => loginInfoChangeHanlder(e, 'username')} />
